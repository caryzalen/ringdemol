...
const ChangeCameraHelper = (function(){ 
  let _spec = null;
  ...
  const that = {
    init: function(spec){
      ...
      _isSelfieCam = _spec.isSelfieCam;

      if (that.is_mobileOrTablet() && _spec.DOMChangeCameraButton){
        _spec.DOMChangeCameraButton.style.display = 'block';
      }
    },


    is_mobileOrTablet: function(){
      //return true; //kill
      let check = false;
...
// Export ES6 module:
try {
  module.exports = ChangeCameraHelper;
} catch(e){
